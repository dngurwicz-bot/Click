...
from sqlalchemy import String, Boolean, Date, DateTime, ForeignKey, Numeric, Integer, Text, func, Sequence
from sqlalchemy.orm import Mapped, mapped_column
from sqlalchemy.dialects.postgresql import UUID
from app.database import Base

_emp_seq = Sequence("employees_number_seq")
...
class Employee(Base):
    ...
    employee_number: Mapped[int] = mapped_column(
        Integer, _emp_seq, server_default=_emp_seq.next_value(), nullable=False
    )
    status: Mapped[str] = mapped_column(String, nullable=False, default="active")  # active, inactive, terminated
...
class EmployeeIdentity(Base):
    ...
    first_name_en: Mapped[str | None] = mapped_column(String, nullable=True)
    last_name_en: Mapped[str | None] = mapped_column(String, nullable=True)
    ...
    api_username: Mapped[str | None] = mapped_column(String, nullable=True)
